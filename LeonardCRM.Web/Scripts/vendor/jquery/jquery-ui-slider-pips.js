    ...
    var extensionMethods = {
        ...
        pips: function( settings ) {
            ...
            function createPip( which ) {
                ...
                collection +=
                    "<span class=\"" + classes + " sliderpiphovertooltip\" style=\"" + css + "\"  title=\"" + options.formatLabel(label) + "\" >" +
        ...
        float: function( settings ) {
            ...
            if ( options.handle ) {
                ...
                // else if its just a normal slider
                    ...
                    //$tip = $("<span class=\"ui-slider-tip\" data-toggle=\"popover\" data-placement=\"auto\" data-content=\" \">" + options.formatLabel(val) + "</span>");
                    //$tip = $("<span class=\"sliderpiptooltip\" data-container=\".repeater-item\" data-toggle=\"popover\" data-placement=\"auto\" data-content=\"" + options.formatLabel(val) + "\"></span>");
                    $tip = $("<span class=\"sliderpiptooltip\" title=\"" + options.formatLabel(val) + "\"></span>");
            ...
            slider.element.on( options.event , function( e, ui ) {
                ...
                $(ui.handle).find(".sliderpiptooltip").tooltipster('content', options.formatLabel(val));
            });
